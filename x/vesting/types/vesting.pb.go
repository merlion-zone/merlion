...
// source: merlion/vesting/v1/vesting.proto
...
func init() {
	proto.RegisterType((*Airdrop)(nil), "merlion.vesting.v1.Airdrop")
}

func init() { proto.RegisterFile("merlion/vesting/v1/vesting.proto", fileDescriptor_9e59ec182944cd7f) }
