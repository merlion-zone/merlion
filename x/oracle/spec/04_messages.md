...
> Delegate validators will likely require you to deposit some funds (in Mer or Lion) which they can use to pay fees, sent in a separate MsgSend. This agreement is made off-chain and not enforced by the Merlion protocol.
