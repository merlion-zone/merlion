...
func init() {
	...
	proto.RegisterType((*QueryTargetsRequest)(nil), "merlion.oracle.v1.QueryTargetsRequest")
	proto.RegisterType((*QueryTargetsResponse)(nil), "merlion.oracle.v1.QueryTargetsResponse")
...
func (c *queryClient) Targets(ctx context.Context, in *QueryTargetsRequest, opts ...grpc.CallOption) (*QueryTargetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlion.oracle.v1.Query/Targets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Targets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlion.oracle.v1.Query/Targets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
