...
var (
	...
	pattern_Query_Targets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"merlion", "oracle", "v1", "denoms", "targets"}, "", runtime.AssumeColonVerbOpt(true)))
