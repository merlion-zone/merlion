		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if err != nil {
				...
				if keyringBackend != "" && clientCtx.Keyring == nil {
					kb, err = keyring.New(sdk.KeyringServiceName(), keyringBackend, clientCtx.HomeDir, inBuf, evmoskr.Option())
					if err != nil {
						return err
					}
				} else {
			...
			if clawback {
				// ClawbackVestingAccount requires clawback, lockup, vesting, and funder flags
				var (
					lockupStart                   int64
				...
				// Align schedules in case lockup and vesting schedules have different start_time
