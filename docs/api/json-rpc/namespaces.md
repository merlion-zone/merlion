...
Check the JSON-RPC namespaces supported on Merlion. {synopsis}
...
|--------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|--------------------|
| [`eth`](./endpoints.md#eth-methods)           | Merlion provides several extensions to the standard `eth` JSON-RPC namespace.                                                                                                                                                | ✔         | ✔                  |
